...
<html>
  <head><title>Κάγκελα Inoxergo</title>
<%
  ...
  <div class="rightcol">
      <% for (int l = 1; l < 11; l++) {
          ...
          if (!(check==null)) {%>
  <a href="#" onclick='$.prettyPhoto.open(img,gallery_titles<%=l-1%>,gallery_descriptions<%=l-1%>);' ><img src="<%=imgsource[l-1].getImgpath()%>" alt="<%=imgsource[l-1].getTitle()%>" title="<%=imgsource[l-1].getTitle()%>" width="120" height="90"></a>
      <% }}  %>
  </div>
  </body>
</html>